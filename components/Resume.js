...
const Resume = () => {
  ...
  return (
    <section class="bg-black m-8 rounded-2xl text-white">
          ...
          <div>
            ...
            <div>
              {educationdata?.map((item, index) => (
                <div
                  key={index}
                  className="education-box my-6 rounded-lg border border-gray-300 bg-gradient-to-r from-gray-900 to-gray-800 p-8 shadow-md hover:border-pink-500 hover:shadow-xl transition duration-300"
                >
                  <div className="text-white text-sm">{item.year}</div>

                  <h2 className="mt-4 text-2xl font- text-white">
                    {item.name}
                  </h2>
          ...
          <div>
            ...
            <div>
              {experiencedata?.map((item, index) => (
                <div
                  key={index}
                  className="experience-box my-6 rounded-lg border border-gray-300 bg-gradient-to-r from-gray-900 to-gray-800 p-8 shadow-md hover:border-pink-500 hover:shadow-xl transition duration-300"
                >
                  <div className="text-white text-sm">{item.year}</div>
